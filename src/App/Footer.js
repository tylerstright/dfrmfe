            ...
            <Container >
                <Row>
                    ...
                    <Col>
                        ...
                        <a className={'p-1'} href="https://www.facebook.com/Nez-Perce-Tribe-1653756024857496" target="_blank"><img src={facebook} alt="Facebook" /></a>
                        <a className={'p-1'} href="https://twitter.com/NezPerce_Tribe" target="_blank"><img src={twitter} alt="Twitter" /></a>
                        <a className={'p-1'} href="https://www.instagram.com/nezpercetribe/" target="_blank"><img src={instagram} alt="Instagram" /></a>
                    </Col>
                </Row>
